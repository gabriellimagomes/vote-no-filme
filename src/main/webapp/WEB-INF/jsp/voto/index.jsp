<form action="<c:url value="/voto" />" method="post">
	<div class="panel panel-primary">
		<c:if test="${!empty erro}">
			<div class="panel-heading"><h1 class="text-center">${erro}</h1></div>
		</c:if>
		<c:if test="${empty erro}">
			...
			<div class="panel-body">
				<div class="row">
					<div class="col-md-6" id="divFilme1">
						<div class="thumbnail">
							<img alt="filme para vota̤ao" src="<c:url value="/images/img${filme1.id}.jpg" />" class="img-thumbnail" />
							<div class="caption">
					...
					<div class="col-md-6" id="divFilme2">
						<div class="thumbnail">
							<img alt="filme para vota̤ao" src="<c:url value="/images/img${filme2.id}.jpg" />" class="img-thumbnail" />
